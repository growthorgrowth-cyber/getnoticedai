(function(){
  ...
  function metaTrack(eventName, params){try{ if (typeof window.fbq==='function') window.fbq('track', eventName, params||{}); }catch(_){}}
  function metaTrackCustom(eventName, params){try{ if (typeof window.fbq==='function') window.fbq('trackCustom', eventName, params||{}); }catch(_){}}
  if (/^\/audit(\/|\.html)?$/.test(location.pathname) || location.pathname.indexOf('/audit/')===0){metaTrack('ViewContent',{content_name:'free_audit',content_category:'lead_magnet'});}
  if (location.pathname.indexOf('/local-seo-for-')===0){metaTrack('ViewContent',{content_name:clean(location.pathname),content_category:'industry_landing'});}
